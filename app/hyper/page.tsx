...
const slides = [
  {
    src: "/hypertrophy.png",
    text: "Bottom left part of the heart got enlarged.",
  },
];

// Video content
const videoData = {
  src: "/hypertrophy_2.mp4",
  description: "This 3D animation illustrates hypertrophy.",
};
    ...
    <div className="min-h-screen bg-gradient-to-tr from-white via-blue-50 to-blue-100 p-4 md:p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold text-gray-800">🫀 Hypertrophy</h1>
